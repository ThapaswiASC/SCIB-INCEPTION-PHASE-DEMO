...
class TaskValidatorTest {
    ...
    void validateCreateRequest_WithNullTitle_ThrowsValidationException() {
        TaskCreateRequest request = new TaskCreateRequest(null, "Valid Description");
    ...
    void validateCreateRequest_WithEmptyTitle_ThrowsValidationException() {
        TaskCreateRequest request = new TaskCreateRequest("", "Valid Description");
    ...
    void validateCreateRequest_WithTitleTooLong_ThrowsValidationException() {
        ...
        TaskCreateRequest request = new TaskCreateRequest(longTitle, "Valid Description");
    ...
    void validateCreateRequest_WithTitleExactly200Characters_DoesNotThrowException() {
        ...
        TaskCreateRequest request = new TaskCreateRequest(title, "Valid Description");
    ...
    void validateCreateRequest_WithNullDescription_ThrowsValidationException() {
        TaskCreateRequest request = new TaskCreateRequest("Valid Title", null);
    ...
    void validateCreateRequest_WithEmptyDescription_ThrowsValidationException() {
        TaskCreateRequest request = new TaskCreateRequest("Valid Title", "");
    ...
    void validateCreateRequest_WithDescriptionTooLong_ThrowsValidationException() {
        ...
        TaskCreateRequest request = new TaskCreateRequest("Valid Title", longDescription);
    ...
    void validateCreateRequest_WithDescriptionExactly1000Characters_DoesNotThrowException() {
        ...
        TaskCreateRequest request = new TaskCreateRequest("Valid Title", description);
    ...
    void validateUpdateRequest_WithNullTitle_ThrowsValidationException() {
        TaskUpdateRequest request = new TaskUpdateRequest(null, "Valid Description", TaskStatus.IN_PROGRESS);
    ...
    void validateUpdateRequest_WithEmptyTitle_ThrowsValidationException() {
        TaskUpdateRequest request = new TaskUpdateRequest("", "Valid Description", TaskStatus.IN_PROGRESS);
    ...
    void validateUpdateRequest_WithTitleTooLong_ThrowsValidationException() {
        String longTitle = "a".repeat(201);
        TaskUpdateRequest request = new TaskUpdateRequest(longTitle, "Valid Description", TaskStatus.IN_PROGRESS);
    ...
    void validateUpdateRequest_WithNullDescription_ThrowsValidationException() {
        TaskUpdateRequest request = new TaskUpdateRequest("Valid Title", null, TaskStatus.IN_PROGRESS);
    ...
    void validateUpdateRequest_WithEmptyDescription_ThrowsValidationException() {
        TaskUpdateRequest request = new TaskUpdateRequest("Valid Title", "", TaskStatus.IN_PROGRESS);
    ...
    void validateUpdateRequest_WithDescriptionTooLong_ThrowsValidationException() {
        String longDescription = "a".repeat(1001);
        TaskUpdateRequest request = new TaskUpdateRequest("Valid Title", longDescription, TaskStatus.IN_PROGRESS);
    ...
    void validateUpdateRequest_WithNullStatus_ThrowsValidationException() {
        TaskUpdateRequest request = new TaskUpdateRequest("Valid Title", "Valid Description", null);
    ...
    void validateUpdateRequest_WithMultipleErrors_ThrowsValidationExceptionWithAllErrors() {
        TaskUpdateRequest request = new TaskUpdateRequest("", "", null);
